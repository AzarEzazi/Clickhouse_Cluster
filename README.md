...
| Test query Node1 | http://192.168.56.129:8123/?user=default&password=your_password&query=SELECT%201 |
| Test query Node2 | http://192.168.56.137:8123/?user=default&password=your_password&query=SELECT%201 |
| Test query via HAProxy | http://192.168.56.138:18123/?user=default&password=your_password&query=SELECT%201 |
...
Lab password used here: `your_password` (change in real production).
...
If prompted for `default` password: `your password`
...
<clickhouse>
    <users>
        <default replace="replace">
            <password_sha256_hex>hash_password</password_sha256_hex>
            <networks>
